...
[ "I-0",  "H-B1",  "I-0",  "I-20",  "I-0",   "I-0",  "I-0",    "H-1", "I-0", "I-0", "I-0",  "I-0",   "I-0",   "I-0",   "I-0",  "I-0"],
[ "I-0",  "H-B1",  "I-5",  "I-20",  "I-2",   "H-FF",  "I-0",   "H-1", "I-0", "I-0", "I-0",  "I-0",   "I-0",   "I-0",   "I-0",  "I-0"],
[ "I-0",  "H-B1",  "I-5",  "I-20",  "I-0",   "H-FF",  "I-0",   "H-1", "I-0", "I-0", "I-0",  "I-0",   "I-0",   "I-0",   "I-0",  "I-0"],
[ "I-0",  "H-B1",  "I-1",  "I-20",  "I-0",   "I-16",  "I-0",   "H-1", "I-0", "I-0", "I-0",  "I-0",   "I-0",   "I-0",   "I-0",  "I-0"],
[ "I-0",  "H-B1",  "I-1",  "I-20",  "I-0",   "I-8",  "I-0",   "H-1", "I-0", "I-0", "I-0",  "I-0",   "I-0",   "I-0",   "I-0",  "I-0"],
[ "I-0",  "H-B1",  "I-1",  "I-20",  "I-0",   "I-4",  "I-0",   "H-1", "I-0", "I-0", "I-0",  "I-0",   "I-0",   "I-0",   "I-0",  "I-0"],
[ "I-0",  "H-B1",  "I-1",  "I-20",  "I-0",   "I-8",  "I-0",   "H-1", "I-0", "I-0", "I-0",  "I-0",   "I-0",   "I-0",   "I-0",  "I-0"],
[ "I-0",  "H-B1",  "I-1",  "I-20",  "I-0",   "I-1",  "I-0",   "H-1", "I-0", "I-0", "I-0",  "I-0",   "I-0",   "I-0",   "I-0",  "I-0"],
...
# **************************************************************************************
    ...
    # ASSERTION 3 
	if (int(('{:032b}'.format(ver_basic))[18], 2) == 1): # BOS 1
		file.write("ASSERTION 3 NOT MET !!!\n")
	else:
		pass

    # ASSERTION 4
	if (int(('{:032b}'.format(ver_basic))[19], 2) == 1): # BOS 2
		file.write("ASSERTION 4 NOT MET !!!\n")
	else:
		pass

    # ASSERTION 5
	if (int(('{:032b}'.format(ver_basic))[20], 2) == 1): # BOS 3
		file.write("ASSERTION 5 NOT MET !!!\n")
	else:
		pass

	# ASSERTION 6
	if (int(('{:032b}'.format(ver_basic))[21], 2) == 1): # BOS 4
		file.write("ASSERTION 6 NOT MET !!!\n")
	else:
		pass

	# ASSERTION 7
	if (int(('{:032b}'.format(ver_basic))[22], 2) == 1): # BOS 5
