...
[ "I-0",  "H-B1",  "I-5",   "I-3",  "I-2",   "H-1F",  "I-0",   "H-1", "I-0", "I-0", "I-0",  "I-0",   "I-0",   "I-0",   "I-0",  "I-0"],
[ "I-0",  "H-B1",  "I-5",   "I-3",  "I-3",   "H-1F",  "I-0",   "H-1", "I-0", "I-0", "I-0",  "I-0",   "I-0",   "I-0",   "I-0",  "I-0"],
[ "I-0",  "H-B1",  "I-5",   "I-3",  "I-4",   "H-1F",  "I-0",   "H-1", "I-0", "I-0", "I-0",  "I-0",   "I-0",   "I-0",   "I-0",  "I-0"],
...
# **************************************************************************************
    ...
    # ASSERTION 3
	if (('{:032b}'.format(ver_basic))[23] == str(1)): # e
		file.write("ASSERTION 3 NOT MET !!!\n")
	else:
		pass

    # ASSERTION 4
	if (('{:032b}'.format(ver_basic))[16] == str(1)): # pro
	...
	if (int(('{:032b}'.format(ver_basic))[0:16], 2) != int(pktsizelist[0])):
