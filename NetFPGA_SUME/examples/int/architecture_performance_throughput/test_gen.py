...
# **************************************************************************************
    ...
    # ASSERTION 2
	if (oqs_packets_out < (burstsizelist[0])):
		file.write("ASSERTION 2 NOT MET !!!\n")
	else:
		pass

    # ASSERTION 3 
	if (oqs_stored_nf0 != (burstsizelist[0])): # SIZE
		file.write("ASSERTION 3 NOT MET !!!\n")
	else:
		pass

    # ASSERTION 4
	if (oqs_removed_nf0 != (burstsizelist[0])):
		file.write("ASSERTION 4 NOT MET !!!\n")
	else:
		pass

    # ASSERTION 5
	if ((oqs_dropped_nf0 != 0) and (oqs_dropped_nf1 != 0) and (oqs_dropped_nf2 != 0) and (oqs_dropped_nf3 != 0)):
