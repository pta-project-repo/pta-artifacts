...
# **************************************************************************************
	...
	# ipid ++ qocc ++ epid ++ tst ++ p.int_switch_id.switch_id[27:0];

	#print("ALL")
	#print(int(('{:032b}'.format(ver_meta))[0:32], 2))

	mt_swid = int(('{:032b}'.format(ver_meta))[4:32], 2)
	mt_inptid = int(('{:032b}'.format(ver_meta))[0], 2)
	mt_qoc = int(('{:032b}'.format(ver_meta))[1], 2)
	mt_ints = int(('{:032b}'.format(ver_meta))[3], 2)
	mt_egptid = int(('{:032b}'.format(ver_meta))[2], 2)
