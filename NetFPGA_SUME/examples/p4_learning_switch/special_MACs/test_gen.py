...
meta =[
	...
	["H-EE", "H-EE", "H-EE"], #m7
	["I-0", "I-0", "I-0"], #m8
	["B-00000001", "B-00000001", "B-00000001"], #m9
	["H-00", "H-FF", "H-01"], #m10
	["H-00", "H-FF", "H-DD"], #m11
	["H-00", "H-FF", "H-DD"], #m12
	["H-00", "H-FF", "H-DD"], #m13
	...
	for gap in gapsizelist:
		...
		for burst in burstsizelist:
			...
			for metacol in range(numcol):
				...
				subprocess.Popen(["./learn.py"], stdout=FNULL)
				# SLEEP
				os.chdir(tools)			
...
# **************************************************************************************
	...
	# ASSERTION 1
	if ((oqs_packets_out == 0) and (ver_packet_counter == 0)):
		pass
	else:
		file.write("ASSERTION 1 NOT MET !!!\n")

    # ASSERTION 2
	if ((nf0_packets_out == 0) and (nf1_packets_out == 0) and (nf2_packets_out == 0) and (nf3_packets_out == 0)):
		pass
	else:
