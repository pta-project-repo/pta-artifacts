...
meta =[
	...
	[  "H-FF", "H-FF", "H-FF",  "H-FF",  "H-FF",  "H-FF",  "H-FF",  "H-FF",  "H-FF",  "H-FF",  "H-FF",  "H-FF",  "H-FF",  "H-FF",  "H-FF",  "H-FF",  "H-FF",  "H-00",  "H-03",  "H-17"  ], #m7
...
for pktsize in pktsizelist:
	...
	for gap in gapsizelist:
		...
		# GENERATE LAST TRAINING PACKET
		os.chdir(tools)
		subprocess.call(["./genpkts.sh", "-b", str(burst), "-f", meta[0][16], "-g", str(gpgap), "-p", str(pktsize), "-s", str(hdr), "--m1", meta[1][16], "--m2", meta[2][16], "--m3", meta[3][16], "--m4", meta[4][16], "--m5", meta[5][16], "--m6", meta[6][16], "--m7", meta[7][16], "--m8", meta[8][16], "--m9", meta[9][16], "--m10", meta[10][16], "--m11", meta[11][16], "--m12", meta[12][16], "--m13", meta[13][16], "--m14", meta[14][16], "--m15", meta[15][16]] )
		subprocess.call(["sleep", str(1)])
