...
create_ip -name action_generator -vendor NetFPGA -library NetFPGA -module_name action_generator_ip
set_property -dict [list CONFIG.C_BASEADDR $INPUT_ARBITER_BASEADDR] [get_ips action_generator_ip]
set_property generate_synth_checkpoint false [get_files action_generator_ip.xci]
reset_target all [get_ips action_generator_ip]
generate_target all [get_ips action_generator_ip]
...
# Add top level AXI Lite control signals to action generator
add_wave_divider {Action Generator Control Signals}
#add_wave top_tb/top_sim/M01_AXI_araddr
#add_wave top_tb/top_sim/M01_AXI_arprot
#add_wave top_tb/top_sim/M01_AXI_arready
#add_wave top_tb/top_sim/M01_AXI_arvalid
#add_wave top_tb/top_sim/M01_AXI_awaddr
#add_wave top_tb/top_sim/M01_AXI_awprot
#add_wave top_tb/top_sim/M01_AXI_awready
#add_wave top_tb/top_sim/M01_AXI_awvalid
#add_wave top_tb/top_sim/M01_AXI_bready
#add_wave top_tb/top_sim/M01_AXI_bresp
#add_wave top_tb/top_sim/M01_AXI_bvalid
#add_wave top_tb/top_sim/M01_AXI_rdata
#add_wave top_tb/top_sim/M01_AXI_rready
#add_wave top_tb/top_sim/M01_AXI_rresp
#add_wave top_tb/top_sim/M01_AXI_rvalid
#add_wave top_tb/top_sim/M01_AXI_wdata
#add_wave top_tb/top_sim/M01_AXI_wready
#add_wave top_tb/top_sim/M01_AXI_wstrb
#add_wave top_tb/top_sim/M01_AXI_wvalid

add_wave $nf_datapath/S0_AXI_AWADDR
add_wave $nf_datapath/S0_AXI_AWVALID
add_wave $nf_datapath/S0_AXI_WDATA
add_wave $nf_datapath/S0_AXI_WSTRB
add_wave $nf_datapath/S0_AXI_WVALID
add_wave $nf_datapath/S0_AXI_BREADY
add_wave $nf_datapath/S0_AXI_ARADDR
add_wave $nf_datapath/S0_AXI_ARVALID
add_wave $nf_datapath/S0_AXI_RREADY
add_wave $nf_datapath/S0_AXI_ARREADY
add_wave $nf_datapath/S0_AXI_RDATA
add_wave $nf_datapath/S0_AXI_RRESP
add_wave $nf_datapath/S0_AXI_RVALID
add_wave $nf_datapath/S0_AXI_WREADY
add_wave $nf_datapath/S0_AXI_BRESP
add_wave $nf_datapath/S0_AXI_BVALID
add_wave $nf_datapath/S0_AXI_AWREADY
...
add_wave_divider {P4 Module Wrapper input signals}
add_wave $nf_datapath/s_axis_opl_tdata 
add_wave $nf_datapath/s_axis_opl_tkeep 
add_wave $nf_datapath/s_axis_opl_tuser 
add_wave $nf_datapath/s_axis_opl_tvalid 
add_wave $nf_datapath/s_axis_opl_tready 
add_wave $nf_datapath/s_axis_opl_tlast

add_wave_divider {P4 Module Wrapper output signals}
add_wave $nf_datapath/m_axis_opl_tdata 
add_wave $nf_datapath/m_axis_opl_tkeep 
add_wave $nf_datapath/m_axis_opl_tuser 
add_wave $nf_datapath/m_axis_opl_tvalid 
add_wave $nf_datapath/m_axis_opl_tready 
add_wave $nf_datapath/m_axis_opl_tlast
...
add_wave $nf_sume_sdnet_ip/in_ag_pkt_type
...
add_wave $nf_sume_sdnet_ip/out_ag_pkt_type
