...
### PKTGEN
create_ip -name nf_sume_pktgen -vendor NetFPGA -library NetFPGA -module_name nf_sume_pktgen_ip
set_property generate_synth_checkpoint false [get_files nf_sume_pktgen_ip.xci]
reset_target all [get_ips nf_sume_pktgen_ip]
generate_target all [get_ips nf_sume_pktgen_ip]
