...
#  create_bd_pin -dir I -type clk M08_ACLK
#  create_bd_pin -dir I -type rst M08_ARESETN
  ...
  create_bd_pin -dir I -type clk M13_ACLK
  create_bd_pin -dir I -type rst M13_ARESETN
  create_bd_pin -dir I -type clk M14_ACLK
  create_bd_pin -dir I -type rst M14_ARESETN
  create_bd_pin -dir I -type clk M15_ACLK
  create_bd_pin -dir I -type rst M15_ARESETN
  create_bd_pin -dir I -type clk M16_ACLK
  create_bd_pin -dir I -type rst M16_ARESETN
  create_bd_pin -dir I -type clk M17_ACLK
  create_bd_pin -dir I -type rst M17_ARESETN
  create_bd_pin -dir I -type clk M18_ACLK
  create_bd_pin -dir I -type rst M18_ARESETN
  create_bd_pin -dir I -type clk M19_ACLK
  create_bd_pin -dir I -type rst M19_ARESETN
  create_bd_pin -dir I -type clk M20_ACLK
  create_bd_pin -dir I -type rst M20_ARESETN
  ...
  set_property -dict [list CONFIG.M12_HAS_REGSLICE {3} CONFIG.M12_HAS_DATA_FIFO {1} ] $axi_interconnect_0
  set_property -dict [list CONFIG.M13_HAS_REGSLICE {3} CONFIG.M13_HAS_DATA_FIFO {1} ] $axi_interconnect_0
  set_property -dict [list CONFIG.M14_HAS_REGSLICE {3} CONFIG.M14_HAS_DATA_FIFO {1} ] $axi_interconnect_0
  set_property -dict [list CONFIG.M15_HAS_REGSLICE {3} CONFIG.M15_HAS_DATA_FIFO {1} ] $axi_interconnect_0
  set_property -dict [list CONFIG.M16_HAS_REGSLICE {3} CONFIG.M16_HAS_DATA_FIFO {1} ] $axi_interconnect_0
  set_property -dict [list CONFIG.M17_HAS_REGSLICE {3} CONFIG.M17_HAS_DATA_FIFO {1} ] $axi_interconnect_0
  set_property -dict [list CONFIG.M18_HAS_REGSLICE {3} CONFIG.M18_HAS_DATA_FIFO {1} ] $axi_interconnect_0
  set_property -dict [list CONFIG.M19_HAS_REGSLICE {3} CONFIG.M19_HAS_DATA_FIFO {1} ] $axi_interconnect_0
  set_property -dict [list CONFIG.M20_HAS_REGSLICE {3} CONFIG.M20_HAS_DATA_FIFO {1} ] $axi_interconnect_0
...
#  connect_bd_intf_net -intf_net axi_interconnect_0_M08_AXI [get_bd_intf_pins M08_AXI] [get_bd_intf_pins axi_interconnect_0/M08_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M18_AXI [get_bd_intf_pins M18_AXI] [get_bd_intf_pins axi_interconnect_0/M18_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M19_AXI [get_bd_intf_pins M19_AXI] [get_bd_intf_pins axi_interconnect_0/M19_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M20_AXI [get_bd_intf_pins M20_AXI] [get_bd_intf_pins axi_interconnect_0/M20_AXI]
...
#connect_bd_net -net M08_ACLK_i [get_bd_pins M08_ACLK] [get_bd_pins axi_interconnect_0/M08_ACLK] 
...
connect_bd_net -net M12_ACLK_i [get_bd_pins M12_ACLK] [get_bd_pins axi_interconnect_0/M12_ACLK] 
connect_bd_net -net M13_ACLK_i [get_bd_pins M13_ACLK] [get_bd_pins axi_interconnect_0/M13_ACLK] 
connect_bd_net -net M14_ACLK_i [get_bd_pins M14_ACLK] [get_bd_pins axi_interconnect_0/M14_ACLK] 
connect_bd_net -net M15_ACLK_i [get_bd_pins M15_ACLK] [get_bd_pins axi_interconnect_0/M15_ACLK] 
connect_bd_net -net M16_ACLK_i [get_bd_pins M16_ACLK] [get_bd_pins axi_interconnect_0/M16_ACLK] 
connect_bd_net -net M17_ACLK_i [get_bd_pins M17_ACLK] [get_bd_pins axi_interconnect_0/M17_ACLK] 
connect_bd_net -net M18_ACLK_i [get_bd_pins M18_ACLK] [get_bd_pins axi_interconnect_0/M18_ACLK] 
connect_bd_net -net M19_ACLK_i [get_bd_pins M19_ACLK] [get_bd_pins axi_interconnect_0/M19_ACLK] 
connect_bd_net -net M20_ACLK_i [get_bd_pins M20_ACLK] [get_bd_pins axi_interconnect_0/M20_ACLK] 
...
#connect_bd_net -net M08_ARESETN_i [get_bd_pins M08_ARESETN]  [get_bd_pins axi_interconnect_0/M08_ARESETN]
...
connect_bd_net -net M12_ARESETN_i [get_bd_pins M12_ARESETN]  [get_bd_pins axi_interconnect_0/M12_ARESETN]
connect_bd_net -net M13_ARESETN_i [get_bd_pins M13_ARESETN]  [get_bd_pins axi_interconnect_0/M13_ARESETN]
connect_bd_net -net M14_ARESETN_i [get_bd_pins M14_ARESETN]  [get_bd_pins axi_interconnect_0/M14_ARESETN]
connect_bd_net -net M15_ARESETN_i [get_bd_pins M15_ARESETN]  [get_bd_pins axi_interconnect_0/M15_ARESETN]
connect_bd_net -net M16_ARESETN_i [get_bd_pins M16_ARESETN]  [get_bd_pins axi_interconnect_0/M16_ARESETN]
connect_bd_net -net M17_ARESETN_i [get_bd_pins M17_ARESETN]  [get_bd_pins axi_interconnect_0/M17_ARESETN]
connect_bd_net -net M18_ARESETN_i [get_bd_pins M18_ARESETN]  [get_bd_pins axi_interconnect_0/M18_ARESETN]
connect_bd_net -net M19_ARESETN_i [get_bd_pins M19_ARESETN]  [get_bd_pins axi_interconnect_0/M19_ARESETN]
connect_bd_net -net M20_ARESETN_i [get_bd_pins M20_ARESETN]  [get_bd_pins axi_interconnect_0/M20_ARESETN]
...
#  set_property -dict [ list CONFIG.ADDR_WIDTH {12} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $M08_AXI
  ...
  set_property -dict [ list CONFIG.ADDR_WIDTH {12} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $M12_AXI
  set M13_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M13_AXI ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {12} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $M13_AXI
  set M14_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M14_AXI ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {12} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $M14_AXI
  set M15_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M15_AXI ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {12} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $M15_AXI
  set M16_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M16_AXI ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {12} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $M16_AXI
  set M17_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M17_AXI ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {12} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $M17_AXI
  set M18_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M18_AXI ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {12} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $M18_AXI
  set M19_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M19_AXI ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {12} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $M19_AXI
  set M20_AXI [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M20_AXI ]
  set_property -dict [ list CONFIG.ADDR_WIDTH {12} CONFIG.DATA_WIDTH {32} CONFIG.PROTOCOL {AXI4LITE}  ] $M20_AXI
  ...
  #connect_bd_intf_net -intf_net dma_sub_M08_AXI [get_bd_intf_ports M08_AXI] [get_bd_intf_pins dma_sub/M08_AXI]
  ...
  connect_bd_intf_net -intf_net dma_sub_M12_AXI [get_bd_intf_ports M12_AXI] [get_bd_intf_pins dma_sub/M12_AXI]
  connect_bd_intf_net -intf_net dma_sub_M13_AXI [get_bd_intf_ports M13_AXI] [get_bd_intf_pins dma_sub/M13_AXI]
  connect_bd_intf_net -intf_net dma_sub_M14_AXI [get_bd_intf_ports M14_AXI] [get_bd_intf_pins dma_sub/M14_AXI]
  connect_bd_intf_net -intf_net dma_sub_M15_AXI [get_bd_intf_ports M15_AXI] [get_bd_intf_pins dma_sub/M15_AXI]
  connect_bd_intf_net -intf_net dma_sub_M16_AXI [get_bd_intf_ports M16_AXI] [get_bd_intf_pins dma_sub/M16_AXI]
  connect_bd_intf_net -intf_net dma_sub_M17_AXI [get_bd_intf_ports M17_AXI] [get_bd_intf_pins dma_sub/M17_AXI]
  connect_bd_intf_net -intf_net dma_sub_M18_AXI [get_bd_intf_ports M18_AXI] [get_bd_intf_pins dma_sub/M18_AXI]
  connect_bd_intf_net -intf_net dma_sub_M19_AXI [get_bd_intf_ports M19_AXI] [get_bd_intf_pins dma_sub/M19_AXI]
  connect_bd_intf_net -intf_net dma_sub_M20_AXI [get_bd_intf_ports M20_AXI] [get_bd_intf_pins dma_sub/M20_AXI]
  ...
  create_bd_addr_seg -range $M12_SIZEADDR -offset $M12_BASEADDR [get_bd_addr_spaces dma_sub/nf_riffa_dma_1/m_axi_lite] [get_bd_addr_segs M12_AXI/Reg] SEG_M12_AXI_Reg
  create_bd_addr_seg -range $M13_SIZEADDR -offset $M13_BASEADDR [get_bd_addr_spaces dma_sub/nf_riffa_dma_1/m_axi_lite] [get_bd_addr_segs M13_AXI/Reg] SEG_M13_AXI_Reg
  create_bd_addr_seg -range $M14_SIZEADDR -offset $M14_BASEADDR [get_bd_addr_spaces dma_sub/nf_riffa_dma_1/m_axi_lite] [get_bd_addr_segs M14_AXI/Reg] SEG_M14_AXI_Reg
  create_bd_addr_seg -range $M15_SIZEADDR -offset $M15_BASEADDR [get_bd_addr_spaces dma_sub/nf_riffa_dma_1/m_axi_lite] [get_bd_addr_segs M15_AXI/Reg] SEG_M15_AXI_Reg
  create_bd_addr_seg -range $M16_SIZEADDR -offset $M16_BASEADDR [get_bd_addr_spaces dma_sub/nf_riffa_dma_1/m_axi_lite] [get_bd_addr_segs M16_AXI/Reg] SEG_M16_AXI_Reg
  create_bd_addr_seg -range $M17_SIZEADDR -offset $M17_BASEADDR [get_bd_addr_spaces dma_sub/nf_riffa_dma_1/m_axi_lite] [get_bd_addr_segs M17_AXI/Reg] SEG_M17_AXI_Reg
  create_bd_addr_seg -range $M18_SIZEADDR -offset $M18_BASEADDR [get_bd_addr_spaces dma_sub/nf_riffa_dma_1/m_axi_lite] [get_bd_addr_segs M18_AXI/Reg] SEG_M18_AXI_Reg
  create_bd_addr_seg -range $M19_SIZEADDR -offset $M19_BASEADDR [get_bd_addr_spaces dma_sub/nf_riffa_dma_1/m_axi_lite] [get_bd_addr_segs M19_AXI/Reg] SEG_M19_AXI_Reg
  create_bd_addr_seg -range $M20_SIZEADDR -offset $M20_BASEADDR [get_bd_addr_spaces dma_sub/nf_riffa_dma_1/m_axi_lite] [get_bd_addr_segs M20_AXI/Reg] SEG_M20_AXI_Reg
