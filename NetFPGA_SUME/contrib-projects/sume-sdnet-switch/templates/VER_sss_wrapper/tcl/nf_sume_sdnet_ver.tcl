...
set design nf_sume_sdnet_ver
set top nf_sume_sdnet_ver
...
read_verilog "./wrapper/nf_sume_sdnet_ver.v"
...
add_files -scan_for_includes ./ver_SimpleSumeSwitch/
import_files -force
