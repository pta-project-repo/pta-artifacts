...
SWITCH_INFO_FILE = os.path.expandvars("$P4_PROJECT_DIR/ppl_src/.sdnet_switch_info.dat")
...
if (len(PX_CAM_TABLES) > 0):
    ...
    libcam=cdll.LoadLibrary(os.path.expandvars('$P4_PROJECT_DIR/ppl_sw/CLI/libcam.so'))
...
if (len(PX_TCAM_TABLES) > 0):
    ...
    libtcam=cdll.LoadLibrary(os.path.expandvars('$P4_PROJECT_DIR/ppl_sw/CLI/libtcam.so'))
...
if (len(PX_LPM_TABLES) > 0):
    ...
    liblpm=cdll.LoadLibrary(os.path.expandvars('$P4_PROJECT_DIR/ppl_sw/CLI/liblpm.so'))
...
TABLE_DEFINES_FILE = os.path.expandvars("$P4_PROJECT_DIR/ppl_sw/CLI/ppl_SimpleSumeSwitch_table_defines.json")
