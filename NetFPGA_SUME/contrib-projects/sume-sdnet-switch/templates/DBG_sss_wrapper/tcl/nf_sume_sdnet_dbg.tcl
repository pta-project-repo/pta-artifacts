...
set design nf_sume_sdnet_dbg
set top nf_sume_sdnet_dbg
...
read_verilog "./wrapper/nf_sume_sdnet_dbg.v"
...
add_files -scan_for_includes ./dbg_SimpleSumeSwitch/
import_files -force
