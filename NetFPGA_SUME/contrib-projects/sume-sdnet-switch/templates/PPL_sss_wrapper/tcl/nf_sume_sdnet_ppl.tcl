...
set design nf_sume_sdnet_ppl
set top nf_sume_sdnet_ppl
...
read_verilog "./wrapper/nf_sume_sdnet_ppl.v"
...
add_files -scan_for_includes ./ppl_SimpleSumeSwitch/
import_files -force
